...
if (pb.WORKTYPE == 'private') {
    Sophia.tosophia({ pattern: '.', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    Sophia.tosophia({ pattern: '.', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
