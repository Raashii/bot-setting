...
if (Config.WORKTYPE == 'private') {
    ...
    Rashi.tozara({pattern: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC}, (async (message, match) => {
    ...
    Rashi.tozara({pattern: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC}, (async (message, match) => {
