...
if (Config.WORKTYPE == 'private') {
    ...
    Rashi.tozara({pattern: 'meme ?(.*)', fromMe: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
    ...
    Rashi.tozara({pattern: 'meme ?(.*)', fromMe: false, desc: Lang.MEMES_DESC}, (async (message, match) => {    
