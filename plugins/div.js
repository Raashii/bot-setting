...
Julie.tozara({pattern: 'device ?(.*)', fromMe: true, desc: 'to get device info' , dontAddCommandList: true }, async (message, match) => {
...
msg += '```'
 return await message.client.sendMessage(message.jid, msg, MessageType.text, { quoted: message.data });
    ...
    Julie.tozara({pattern: 'device ?(.*)', fromMe: false, desc: 'to get device info' , dontAddCommandList: true }, async (message, match) => {
