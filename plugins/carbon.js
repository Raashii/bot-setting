...
if (Config.WORKTYPE == 'private') {
    ...
    Rashi.tozara({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC}, (async (message, match) => {
    ...
    Rashi.tozara({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
